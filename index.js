  ...
  constructor(r, e, o, g, p) {
    if (r !== void 0)
      if (typeof r == "string") {
        let d = 0;
        try {
          d = l._api._MagickColor_Create(), T(r, (S) => {
...
class E {
  ...
  static checkException(r, e, o) {
    if (!E.isRaised(r))
      return e;
    const g = E.getErrorSeverity(r.value);
    if (g >= Bt.Error)
      E.throw(r, g);
    else if (o !== void 0) {
      const p = E.createError(r.value, g);
      o(p);
    } else
      E.dispose(r);
    return e;
  ...
  isError() {
    return E.isRaised(this.pointer) ? E.getErrorSeverity(this.pointer.value) >= Bt.Error : !1;
  }
  ...
  static throw(r, e) {
    const o = E.createError(r.value, e);
    throw E.dispose(r), o;
  }
  static createError(r, e) {
    const o = E.getMessage(r), g = new K(o, e), p = l._api._MagickExceptionHelper_RelatedCount(r);
    if (p === 0)
      return g;
    const d = [];
    for (let S = 0; S < p; S++) {
      const G = l._api._MagickExceptionHelper_Related(r, S), W = E.getErrorSeverity(G), x = E.createError(G, W);
      d.push(x);
    }
...
class on {
  constructor(r, e, o, g, p, d, S) {
    this.ascent = r, this.descent = e, this.maxHorizontalAdvance = o, this.textHeight = g, this.textWidth = p, this.underlinePosition = d, this.underlineThickness = S;
  }
  /**
  ...
  static _create(r) {
    if (r == 0)
      return null;
    try {
      const e = l._api._TypeMetric_Ascent_Get(r), o = l._api._TypeMetric_Descent_Get(r), g = l._api._TypeMetric_MaxHorizontalAdvance_Get(r), p = l._api._TypeMetric_TextHeight_Get(r), d = l._api._TypeMetric_TextWidth_Get(r), S = l._api._TypeMetric_UnderlinePosition_Get(r), G = l._api._TypeMetric_UnderlineThickness_Get(r);
      return new on(e, o, g, p, d, S, G);
    } finally {
...
class Lt extends Fe {
  constructor(r, e) {
    const g = un._create(e)._use((d) => l._api._DrawingWand_Create(r._instance, d._instance)), p = l._api._DrawingWand_Dispose;
    super(g, p);
  }
  color(r, e, o) {
    E.usePointer((g) => {
  ...
  roundRectangle(r, e, o, g, p, d) {
    E.usePointer((S) => {
      l._api._DrawingWand_RoundRectangle(this._instance, r, e, o, g, p, d, S);
    });
  }
  strokeColor(r) {
    E.usePointer((e) => {
...
var Tt = /* @__PURE__ */ ((t) => (t[t.Undefined = 0] = "Undefined", t[t.Forget = 0] = "Forget", t[t.Northwest = 1] = "Northwest", t[t.North = 2] = "North", t[t.Northeast = 3] = "Northeast", t[t.West = 4] = "West", t[t.Center = 5] = "Center", t[t.East = 6] = "East", t[t.Southwest = 7] = "Southwest", t[t.South = 8] = "South", t[t.Southeast = 9] = "Southeast", t))(Tt || {});
function* mu(t) {
  for (const r of t)
    switch (r) {
      case 2:
...
class Sr extends Fe {
  constructor(r) {
    ...
    if (super(e, o), r._fileName !== void 0 && T(r._fileName, (g) => {
    ...
    r.fontPointsize !== void 0 && l._api._MagickSettings_FontPointsize_Set(this._instance, r.fontPointsize), r.format !== void 0 && T(r.format, (g) => {
...
class Ie extends ft {
  ...
  get syncImageWithExifProfile() {
    const r = this.getDefine("exif:sync-image");
    return r === null ? !0 : r.toLowerCase() === "true";
  }
  set syncImageWithExifProfile(r) {
    this.setDefine("exif:sync-image", r.toString());
  }
  /**
  ...
  _use(r) {
    ...
    if (o !== "" && T(o, (g) => {
      ...
      const g = this.frameIndex ?? 0, p = this.frameCount ?? 1;
      l._api._MagickSettings_SetScene(e._instance, g), l._api._MagickSettings_SetNumberScenes(e._instance, p);
      const d = this.frameCount !== void 0 ? `${g}-${g + p}` : g.toString();
      T(d.toString(), (S) => {
        l._api._MagickSettings_SetScenes(e._instance, S);
      });
    }
    return this.extractArea !== void 0 && T(this.extractArea.toString(), (g) => {
      l._api._MagickSettings_Extract_Set(e._instance, g);
...
class Me extends Array {
  ...
  combine(r, e) {
    let o = e, g = dt.sRGB;
    return typeof r == "number" ? g = r : o = r, this.createImage((p, d) => l._api._MagickImageCollection_Combine(p, g, d.ptr), o);
  }
  complex(r, e) {
  ...
  fx(r, e, o) {
    this.throwIfEmpty();
    let g = J.All, p = o;
    return typeof e == "number" ? g = e : p = e, T(r, (d) => this.createImage((S, G) => l._api._MagickImageCollection_Fx(S, d, g, G.ptr), p));
  }
  merge(r) {
  ...
  montage(r, e) {
    return this.throwIfEmpty(), this.attachImages((o) => {
      const g = r._use((p) => E.use((d) => {
        const S = l._api._MagickImageCollection_Montage(o, p._instance, d.ptr);
        return this.checkResult(S, d);
      }));
      return Me._createFromImages(g, this.getSettings())._use((p) => {
        const d = r.transparentColor;
        return d !== void 0 && p.forEach((S) => {
          S.transparent(d);
        }), p.merge(e);
      });
    });
  ...
  remap(r, e) {
    ...
    this.attachImages((g) => {
      o._use((p) => {
        E.use((d) => {
          l._api._MagickImageCollection_Remap(g, p._instance, r._instance, d.ptr);
        });
      });
    });
  }
  ...
  write(r, e) {
    ...
    e !== void 0 ? d.format = r : (e = r, d.format = p.format), E.use((G) => {
      Ge.use((W) => {
        d._use((x) => {
          this.attachImages((re) => {
            o = l._api._MagickImage_WriteBlob(re, x._instance, W.ptr, G.ptr), g = W.value;
          });
        });
      });
    });
  ...
  createImage(r, e) {
    this.throwIfEmpty();
    const o = this.attachImages((p) => E.use((d) => {
      const S = r(p, d);
      return this.checkResult(S, d);
    }));
  ...
  readOrPing(r, e, o) {
    this.dispose(), E.use((g) => {
      const p = o === void 0 ? new Ie() : new Ie(o);
      p._ping = r, typeof e == "string" ? (p._fileName = e, p._use((d) => {
        const S = l._api._MagickImageCollection_ReadFile(d._instance, g.ptr);
        this.addImages(S, p);
      })) : p._use((d) => {
        ...
        try {
          ...
          const W = l._api._MagickImageCollection_ReadBlob(d._instance, G, 0, S, g.ptr);
          this.addImages(W, p);
        } finally {
          G !== 0 && l._api._free(G);
        }
  ...
  replaceImages(r) {
    this.throwIfEmpty();
    const e = this.attachImages((g) => E.use((p) => {
      const d = r(g, p);
...
class gr {
  static use(r, e, o) {
    ...
    try {
      ...
      return e.isPercentage && (p = new ie(e.width).multiply(r.width), d = new ie(e.height).multiply(r.height)), l._api._MagickRectangle_Width_Set(g, p), l._api._MagickRectangle_Height_Set(g, d), o(g);
    } finally {
...
class Qe extends Fe {
  image;
  constructor(r) {
    const e = E.usePointer((g) => l._api._PixelCollection_Create(r._instance, g)), o = l._api._PixelCollection_Dispose;
  ...
  getArea(r, e, o, g) {
    return E.usePointer((p) => {
      const d = l._api._PixelCollection_GetArea(this._instance, r, e, o, g, p), S = o * g * this.image.channelCount;
  ...
  setArea(r, e, o, g, p) {
    E.usePointer((d) => {
      ...
      du(S, (G) => {
        l._api._PixelCollection_SetArea(this._instance, r, e, o, g, G, S.length, d);
      });
    });
  }
  setPixel(r, e, o) {
  ...
  use(r, e, o, g, p, d) {
    return T(p, (S) => E.use((G) => {
      let W = l._api._PixelCollection_ToByteArray(this._instance, r, e, o, g, S, G.ptr);
      return G.check(() => {
        const x = d(W);
        return W = l._api._MagickMemory_Relinquish(W), x;
...
class ne extends Fe {
  ...
  get boundingBox() {
    return this.useExceptionPointer((r) => {
      const e = l._api._MagickImage_BoundingBox_Get(this._instance, r), o = le._fromRectangle(e);
  ...
  set format(r) {
    T(r.toString(), (e) => l._api._MagickImage_Format_Set(this._instance, e));
  }
  get gamma() {
  ...
  set metaChannelCount(r) {
    this.useExceptionPointer((e) => {
      l._api._MagickImage_MetaChannelCount_Set(this._instance, r, e);
    });
  }
  get orientation() {
  ...
  adaptiveBlur(r, e) {
    ...
    this.useException((p) => {
      const d = l._api._MagickImage_AdaptiveBlur(this._instance, o, g, p.ptr);
      this._setInstance(d, p);
    });
  }
  adaptiveResize(r, e) {
    const o = typeof r == "number" ? new le(0, 0, r, e) : r;
    this.useException((g) => {
      T(o.toString(), (p) => {
        const d = l._api._MagickImage_AdaptiveResize(this._instance, p, g.ptr);
        this._setInstance(d, g);
      });
    });
  }
  adaptiveSharpen(r, e, o) {
    let g = 0;
    const p = e ?? 1;
    let d = o ?? J.Undefined;
    r !== void 0 && (e === void 0 ? d = r : g = r), this.useException((S) => {
      const G = l._api._MagickImage_AdaptiveSharpen(this._instance, g, p, d, S.ptr);
      this._setInstance(G, S);
    });
  }
  addNoise(r, e, o) {
    let g = 1, p = o ?? J.Undefined;
    e !== void 0 && (o === void 0 ? p = e : g = e), this.useException((d) => {
      const S = l._api._MagickImage_AddNoise(this._instance, r, g, p, d.ptr);
  ...
  autoGamma(r) {
    this.useExceptionPointer((e) => {
      const o = this.valueOrDefault(r, J.Composite);
      l._api._MagickImage_AutoGamma(this._instance, o, e);
    });
  }
  autoLevel(r) {
    this.useExceptionPointer((e) => {
      const o = this.valueOrDefault(r, J.Undefined);
  ...
  blur(r, e, o) {
    ...
    let d = this.valueOrDefault(o, J.Undefined);
    r !== void 0 && (e === void 0 ? d = r : g = r), this.useException((S) => {
      const G = l._api._MagickImage_Blur(this._instance, g, p, d, S.ptr);
      this._setInstance(G, S);
    });
  }
  border(r, e) {
    const o = r, g = this.valueOrDefault(e, r), p = new le(0, 0, o, g);
    this.useException((d) => {
      p._toRectangle((S) => {
        const G = l._api._MagickImage_Border(this._instance, S, d.ptr);
        this._setInstance(G, d);
      });
    });
  }
  brightnessContrast(r, e, o) {
    const g = this.valueOrDefault(o, J.Undefined);
    this.useException((p) => {
  ...
  charcoal(r, e) {
    ...
    this.useException((p) => {
      const d = l._api._MagickImage_Charcoal(this._instance, o, g, p.ptr);
      this._setInstance(d, p);
    });
  }
  clahe(r, e, o, g) {
    this.useExceptionPointer((p) => {
      const d = r instanceof ie ? r.multiply(this.width) : r, S = e instanceof ie ? e.multiply(this.height) : e;
  ...
  colorAlpha(r) {
    if (!this.hasAlpha)
      return;
    const e = ne.create();
    e.read(r, this.width, this.height), e.composite(this, Ct.SrcOver, new ve(0, 0)), this._instance = e._instance;
  }
  compare(r, e, o, g) {
    const p = e instanceof lu, d = p ? e.metric : e;
    let S = o;
    g !== void 0 && (S = g);
    let G = J.Undefined;
    if (typeof S != "function")
      return S !== void 0 && (G = S), this.useExceptionPointer((x) => l._api._MagickImage_CompareDistortion(this._instance, r._instance, d, G, x));
    o !== void 0 && typeof o != "function" && (G = o);
    const W = Ne.use(this, (x) => (p && e._setArtifacts(x), _n.use((re) => {
      const pe = this.useExceptionPointer((Je) => l._api._MagickImage_Compare(this._instance, r._instance, d, G, re.ptr, Je)), Pe = re.value, Ce = ne._createFromImage(pe, this._settings);
      return an._create(Pe, Ce);
    })));
    return W.difference._use(() => S(W));
  }
  composite(r, e, o, g, p) {
    let d = 0, S = 0, G = Ct.In, W = J.All, x = null;
    e instanceof ve ? (d = e.x, S = e.y) : e !== void 0 && (G = e), o instanceof ve ? (d = o.x, S = o.y) : typeof o == "string" ? x = o : o !== void 0 && (W = o), typeof g == "string" ? x = g : g !== void 0 && (W = g), p !== void 0 && (W = p), x !== null && this.setArtifact("compose:args", x), this.useExceptionPointer((re) => {
      l._api._MagickImage_Composite(this._instance, r._instance, d, S, G, W, re);
    }), x !== null && this.removeArtifact("compose:args");
  }
  compositeGravity(r, e, o, g, p, d) {
    let S = 0, G = 0, W = Ct.In, x = J.All, re = null;
    o instanceof ve ? (S = o.x, G = o.y) : o !== void 0 && (W = o), g instanceof ve ? (S = g.x, G = g.y) : typeof g == "string" ? re = g : g !== void 0 && (x = g), typeof p == "string" ? re = p : p !== void 0 && (x = p), d !== void 0 && (x = d), re !== null && this.setArtifact("compose:args", re), this.useExceptionPointer((pe) => {
      l._api._MagickImage_CompositeGravity(this._instance, r._instance, e, S, G, W, x, pe);
    }), re !== null && this.removeArtifact("compose:args");
  }
  connectedComponents(r) {
    const e = typeof r == "number" ? new cu(r) : r;
    return Ne.use(this, (g) => (e._setArtifacts(g), this.useException((p) => Ge.use((d) => {
      try {
        const S = l._api._MagickImage_ConnectedComponents(this._instance, e.connectivity, d.ptr, p.ptr);
        return this._setInstance(S, p), sn._create(d.value, this.colormapSize);
      } finally {
        d.value !== 0 && l._api._ConnectedComponent_DisposeList(d.value);
      }
    }))));
  }
  ...
  contrastStretch(r, e, o) {
    ...
    let d = 0, S = this.valueOrDefault(o, J.Undefined);
    e instanceof ie ? d = g - e.multiply(g) : (d = g - r.multiply(g), e !== void 0 && (S = e)), this.useExceptionPointer((G) => {
      l._api._MagickImage_ContrastStretch(this._instance, p, d, S, G);
    });
  }
  static create(r, e, o) {
  ...
  crop(r, e, o) {
    let g, p;
    typeof r != "number" ? (g = r, p = this.valueOrDefault(e, Tt.Undefined)) : e !== void 0 && (g = new le(r, e), p = this.valueOrDefault(o, Tt.Undefined)), this.useException((d) => {
      T(g.toString(), (S) => {
        const G = l._api._MagickImage_Crop(this._instance, S, p, d.ptr);
        this._setInstance(G, d);
      });
    });
  }
  cropToTiles(r, e, o) {
    let g, p;
    return typeof r == "number" && typeof e == "number" && o !== void 0 ? (g = new le(0, 0, r, e), p = o) : typeof r != "number" && typeof e != "number" && (g = r, p = e), this.useException((d) => T(g.toString(), (S) => {
      const G = l._api._MagickImage_CropToTiles(this._instance, S, d.ptr);
  ...
  deskew(r, e) {
    return Ne.use(this, (o) => {
      e !== void 0 && o.setArtifact("deskew:auto-crop", e), this.useException((p) => {
        const d = l._api._MagickImage_Deskew(this._instance, r._toQuantum(), p.ptr);
        this._setInstance(d, p);
      });
  ...
  distort(r, e) {
    Ne.use(this, (o) => {
      let g, p = 0;
      typeof r == "number" ? g = r : (g = r.method, p = r.bestFit ? 1 : 0, r._setArtifacts(o)), this.useException((d) => {
        kr(e, (S) => {
          const G = l._api._MagickImage_Distort(this._instance, g, p, S, e.length, d.ptr);
          this._setInstance(G, d);
        });
      });
    });
  ...
  evaluate(r, e, o, g) {
    if (typeof e == "number") {
      const p = e, d = typeof o == "number" ? o : o._toQuantum();
      this.useExceptionPointer((S) => {
        l._api._MagickImage_EvaluateOperator(this._instance, r, p, d, S);
      });
    } else if (g !== void 0) {
      if (typeof o != "number")
        throw new K("this should not happen");
      const p = e, d = o, S = typeof g == "number" ? g : g._toQuantum();
      if (p.isPercentage)
        throw new K("percentage is not supported");
      this.useExceptionPointer((G) => {
        gr.use(this, p, (W) => {
          l._api._MagickImage_EvaluateGeometry(this._instance, r, W, d, S, G);
        });
      });
    }
  }
  extent(r, e, o) {
    let g = Tt.Undefined, p;
    typeof r != "number" ? p = r : typeof e == "number" && (p = new le(r, e)), typeof e == "number" ? g = e : e !== void 0 && (this.backgroundColor = e), typeof o == "number" ? g = o : o !== void 0 && (this.backgroundColor = o), this.useException((d) => {
      T(p.toString(), (S) => {
        const G = l._api._MagickImage_Extent(this._instance, S, g, d.ptr);
        this._setInstance(G, d);
      });
    });
  }
  ...
  gammaCorrect(r, e) {
    const o = this.valueOrDefault(e, J.Undefined);
    this.useExceptionPointer((g) => {
      l._api._MagickImage_GammaCorrect(this._instance, r, o, g);
    });
  }
  gaussianBlur(r, e, o) {
    const g = this.valueOrDefault(e, 1), p = this.valueOrDefault(o, J.Undefined);
    this.useException((d) => {
      const S = l._api._MagickImage_GaussianBlur(this._instance, r, g, p, d.ptr);
      this._setInstance(S, d);
    });
  }
  getArtifact(r) {
  ...
  getAttribute(r) {
    return this.useException((e) => T(r, (o) => {
    ...
    return this.useExceptionPointer((e) => {
      Ge.use((o) => {
        ...
        if (g !== 0) {
          const p = o.value;
          for (let d = 0; d < p; d++) {
            const S = l._api._MagickColorCollection_GetInstance(g, d), G = w._create(S), W = l._api._MagickColor_Count_Get(S);
            r.set(G.toString(), W);
          }
  ...
  inverseLevel(r, e, o, g) {
    const p = this.valueOrDefault(o, 1), d = this.valueOrDefault(g, J.Composite);
    this.useExceptionPointer((S) => {
      l._api._MagickImage_InverseLevel(this._instance, r.toDouble(), e._toQuantum(), p, d, S);
    });
  }
  ...
  level(r, e, o, g) {
    const p = this.valueOrDefault(o, 1), d = this.valueOrDefault(g, J.Composite);
    this.useExceptionPointer((S) => {
      l._api._MagickImage_Level(this._instance, r.toDouble(), e._toQuantum(), p, d, S);
    });
  }
  linearStretch(r, e) {
  ...
  liquidRescale(r, e) {
    const o = typeof r == "number" ? new le(r, e) : r;
    this.useException((g) => {
      T(o.toString(), (p) => {
        const d = l._api._MagickImage_LiquidRescale(this._instance, p, o.x, o.y, g.ptr);
        this._setInstance(d, g);
      });
    });
  }
  ...
  modulate(r, e, o) {
    ...
    this.useExceptionPointer((d) => {
      ...
      T(S, (G) => {
        l._api._MagickImage_Modulate(this._instance, G, d);
      });
    });
  }
  morphology(r) {
  ...
  readFromCanvas(r, e) {
    ...
    p.format = be.Rgba, p.width = r.width, p.height = r.height, this.useException((d) => {
  ...
  separate(r, e) {
    return this.useException((o) => {
      ...
      return Me._createFromImages(d, this._settings)._use(g);
    });
  }
  ...
  setArtifact(r, e) {
    let o;
    typeof e == "string" ? o = e : typeof e == "boolean" ? o = this.fromBool(e).toString() : o = e.toString(), T(r, (g) => {
      T(o, (p) => {
  ...
  setProfile(r, e) {
    ...
    e !== void 0 ? g = e : typeof r != "string" && (g = r.data), this.useException((p) => {
      T(o, (d) => {
        cr(g, (S) => {
          l._api._MagickImage_SetProfile(this._instance, d, S, g.byteLength, p.ptr);
        });
      });
    });
  }
  ...
  sharpen(r, e, o) {
    const g = this.valueOrDefault(r, 0), p = this.valueOrDefault(e, 1), d = this.valueOrDefault(o, J.Undefined);
    this.useException((S) => {
      const G = l._api._MagickImage_Sharpen(this._instance, g, p, d, S.ptr);
      this._setInstance(G, S);
    });
  }
  shave(r, e) {
  ...
  statistics(r) {
    const e = this.valueOrDefault(r, J.All);
  ...
  wave(r, e, o) {
    const g = this.valueOrDefault(r, this.interpolate), p = this.valueOrDefault(e, 25), d = this.valueOrDefault(o, 150);
    this.useException((S) => {
      const G = l._api._MagickImage_Wave(this._instance, g, p, d, S.ptr);
      this._setInstance(G, S);
    });
  }
  vignette(r, e, o, g) {
    const p = this.valueOrDefault(r, 0), d = this.valueOrDefault(e, 1), S = this.valueOrDefault(o, 0), G = this.valueOrDefault(g, 0);
    this.useException((W) => {
      const x = l._api._MagickImage_Vignette(this._instance, p, d, S, G, W.ptr);
      this._setInstance(x, W);
    });
  }
  write(r, e) {
    let o = 0, g = 0;
    e !== void 0 ? this._settings.format = r : e = r, this.useException((d) => {
      Ge.use((S) => {
        this._settings._use((G) => {
          try {
            o = l._api._MagickImage_WriteBlob(this._instance, G._instance, S.ptr, d.ptr), g = S.value;
          } catch {
  ...
  /** @internal */
  static _clone(r) {
    return E.usePointer((e) => new ne(l._api._MagickImage_Clone(r._instance, e), r._settings._clone()));
  }
  /** @internal */
  _getSettings() {
    return this._settings;
  ...
  _opaque(r, e, o) {
    this.useExceptionPointer((g) => {
      r._use((p) => {
        e._use((d) => {
          l._api._MagickImage_Opaque(this._instance, p, d, this.fromBool(o), g);
        });
      });
    });
  }
  _sigmoidalContrast(r, e, o, g) {
    ...
    const d = this.valueOrDefault(g, J.Undefined);
    this.useExceptionPointer((S) => {
      l._api._MagickImage_SigmoidalContrast(this._instance, this.fromBool(r), e, p, d, S);
    });
  }
  _transparent(r, e) {
    r._use((o) => {
  ...
  static createInstance() {
    return E.usePointer((r) => l._api._MagickImage_Create(0, r));
  }
  fromBool(r) {
    return r ? 1 : 0;
  }
  ...
  readOrPing(r, e, o, g) {
    this.useException((p) => {
      ...
      if (d._ping = r, this._settings._ping = r, d.frameCount !== void 0 && d.frameCount > 1)
      ...
      if (typeof e == "string")
        ...
        d._fileName = "xc:" + e.toShortString(), d.width = typeof o == "number" ? o : 0, d.height = typeof g == "number" ? g : 0;
      d._use((S) => {
  ...
  readFromArray(r, e, o) {
    e._use((g) => {
      cr(r, (p) => {
        const d = l._api._MagickImage_ReadBlob(g._instance, p, 0, r.byteLength, o.ptr);
...
var wu = (() => {
  ...
  return function(r = {}) {
    ...
    var p = Object.assign({}, e), d = "./this.program", S = (n, a) => {
      throw a;
    }, G = typeof window == "object", W = typeof importScripts == "function";
    ...
    var pe, Pe, Ce;
    (G || W) && (W ? x = self.location.href : typeof document < "u" && document.currentScript && (x = document.currentScript.src), t && (x = t), x.indexOf("blob:") !== 0 ? x = x.substr(0, x.replace(/[?#].*/, "").lastIndexOf("/") + 1) : x = "", pe = (n) => {
    ...
    Object.assign(e, p), p = null, e.arguments && e.arguments, e.thisProgram && (d = e.thisProgram), e.quit && (S = e.quit);
    var Ke;
    ...
    var V, te, se, Ze, b, B, yt, ue, gn, wt;
    function mn() {
      var n = ht.buffer;
      e.HEAP8 = V = new Int8Array(n), e.HEAP16 = se = new Int16Array(n), e.HEAP32 = b = new Int32Array(n), e.HEAPU8 = te = new Uint8Array(n), e.HEAPU16 = Ze = new Uint16Array(n), e.HEAPU32 = B = new Uint32Array(n), e.HEAPF32 = yt = new Float32Array(n), e.HEAPF64 = wt = new Float64Array(n), e.HEAP64 = ue = new BigInt64Array(n), e.HEAPU64 = gn = new BigUint64Array(n);
    }
    var Te, fn = [], pn = [], dn = [], Ar = 0;
    function Rr() {
      return br || Ar > 0;
    }
    function Er() {
    ...
    function Hr() {
      ...
      function a(s, u) {
        var c = s.exports;
        return e.asm = c, ht = e.asm.ab, mn(), Te = e.asm.ub, Br(e.asm.bb), St(), c;
      }
      Nt();
      function i(s) {
        a(s.instance);
    ...
    var et = [], z = (n) => {
      var a = et[n];
      return a || (n >= et.length && (et.length = n + 1), et[n] = a = Te.get(n)), a;
    }, Yr = (n, a) => z(n)(a), Ye = 0;
    function kn(n) {
    ...
    var Y = { isAbs: (n) => n.charAt(0) === "/", splitPath: (n) => {
      ...
      for (var h = [], f = m; f < s.length; f++)
        h.push("..");
      return h = h.concat(u.slice(m)), h.join("/");
    } }, Be = (n) => {
    ...
    function kt(n, a, i) {
      var s = Be(n) + 1, u = new Array(s), c = Ft(n, u, 0, u.length);
    ...
    var vn = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, je = (n, a, i) => {
      ...
      for (var c = ""; a < u; ) {
        ...
        var h = n[a++] & 63;
        if ((m & 240) == 224 ? m = (m & 15) << 12 | f << 6 | h : m = (m & 7) << 18 | f << 12 | h << 6 | n[a++] & 63, m < 65536)
          c += String.fromCharCode(m);
        else {
          var y = m - 65536;
...
`)), !a)
      ...
      var a = ir(65536, n);
      return a ? Jr(a, n) : 0;
    }, L = { ops_table: null, mount: function(n) {
      ...
      return _.isDir(u.mode) ? (u.node_ops = L.ops_table.dir.node, u.stream_ops = L.ops_table.dir.stream, u.contents = {}) : _.isFile(u.mode) ? (u.node_ops = L.ops_table.file.node, u.stream_ops = L.ops_table.file.stream, u.usedBytes = 0, u.contents = null) : _.isLink(u.mode) ? (u.node_ops = L.ops_table.link.node, u.stream_ops = L.ops_table.link.stream) : _.isChrdev(u.mode) && (u.node_ops = L.ops_table.chrdev.node, u.stream_ops = L.ops_table.chrdev.stream), u.timestamp = Date.now(), n && (n.contents[a] = u, n.timestamp = u.timestamp), u;
      ...
      a.mode !== void 0 && (n.mode = a.mode), a.timestamp !== void 0 && (n.timestamp = a.timestamp), a.size !== void 0 && L.resizeFileStorage(n, a.size);
    }, lookup: function(n, a) {
      throw _.genericErrors[44];
    }, mknod: function(n, a, i, s) {
      return L.createNode(n, a, i, s);
      ...
      var s = L.createNode(n, a, 41471, 0);
      return s.link = i, s;
    }, readlink: function(n) {
      if (!_.isLink(n.mode))
      ...
      if (L.expandFileStorage(m, u + s), m.contents.subarray && a.subarray)
      ...
      L.expandFileStorage(n.node, a + i), n.node.usedBytes = Math.max(n.node.usedBytes, a + i);
      ...
      return L.stream_ops.write(n, a, 0, s, i, !1), 0;
    } } }, Zr = (n, a, i, s) => {
      var u = `al ${n}`;
      Pe(n, (c) => {
    ...
    function ta(n, a, i, s, u, c, m, f, h, y) {
      var k = a ? he.resolve(Y.join2(n, a)) : n;
      function D(M) {
        function I(C) {
          y && y(), f || _.createDataFile(n, a, C, s, u, h), c && c(), St();
        }
        ea(M, k, I, () => {
          m && m(), St();
        }) || I(M);
    ...
    var _ = { root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: !1, ignorePermissions: !0, ErrnoError: null, genericErrors: {}, filesystems: null, syncFSRequests: 0, lookupPath: (n, a = {}) => {
      ...
      var f = { type: n, opts: a, mountpoint: i, mounts: [] }, h = n.mount(f);
      return h.mount = f, f.root = h, s ? _.root = h : c && (c.mounted = f, c.mount && c.mount.mounts.push(f)), h;
    }, unmount: (n) => {
      ...
      Object.keys(_.nameTable).forEach((m) => {
        for (var f = _.nameTable[m]; f; ) {
          var h = f.name_next;
          u.includes(f.mount) && _.destroyNode(f), f = h;
        }
      }), i.mounted = null;
      ...
      var i = Y.dirname(n), s = Y.dirname(a), u = Y.basename(n), c = Y.basename(a), m, f, h;
      if (m = _.lookupPath(n, { parent: !0 }), f = m.node, m = _.lookupPath(a, { parent: !0 }), h = m.node, !f || !h) throw new _.ErrnoError(44);
      if (f.mount !== h.mount)
      ...
      if (y !== D) {
        ...
        if (I = D ? _.mayDelete(h, c, M) : _.mayCreate(h, c), I)
          throw new _.ErrnoError(I);
        if (!f.node_ops.rename)
          throw new _.ErrnoError(63);
        if (_.isMountpoint(y) || D && _.isMountpoint(D))
          throw new _.ErrnoError(10);
        if (h !== f && (I = _.nodePermissions(f, "w"), I))
          throw new _.ErrnoError(I);
        _.hashRemoveNode(y);
        try {
          f.node_ops.rename(y, h, c);
        } catch (C) {
          throw C;
        } finally {
          _.hashAddNode(y);
      ...
      if (i) {
        ...
        _.chmod(h, f | 146);
        var M = _.open(h, 577);
        _.write(M, i, 0, i.length, 0, c), _.close(M), _.chmod(h, f);
      }
      return h;
      ...
      if (c.prototype.get = function(I) {
        if (!(I > this.length - 1 || I < 0)) {
          var C = I % this.chunkSize, $ = I / this.chunkSize | 0;
          return this.getter($)[C];
        }
        ...
        var C = Number(I.getResponseHeader("Content-length")), $, q = ($ = I.getResponseHeader("Accept-Ranges")) && $ === "bytes", j = ($ = I.getResponseHeader("Content-Encoding")) && $ === "gzip", v = 1024 * 1024;
        q || (v = C);
        var P = (X, oe) => {
          if (X > oe) throw new Error("invalid range (" + X + ", " + oe + ") or no bytes requested!");
          if (oe > C - 1) throw new Error("only " + C + " bytes available! programmer error!");
          var Z = new XMLHttpRequest();
          if (Z.open("GET", i, !1), C !== v && Z.setRequestHeader("Range", "bytes=" + X + "-" + oe), Z.responseType = "arraybuffer", Z.overrideMimeType && Z.overrideMimeType("text/plain; charset=x-user-defined"), Z.send(null), !(Z.status >= 200 && Z.status < 300 || Z.status === 304)) throw new Error("Couldn't load " + i + ". Status: " + Z.status);
          return Z.response !== void 0 ? new Uint8Array(Z.response || []) : kt(Z.responseText || "", !0);
        }, O = this;
        O.setDataGetter((X) => {
          var oe = X * v, Z = (X + 1) * v - 1;
          if (Z = Math.min(Z, C - 1), typeof O.chunks[X] > "u" && (O.chunks[X] = P(oe, Z)), typeof O.chunks[X] > "u") throw new Error("doXHR failed!");
          return O.chunks[X];
        }), (j || !C) && (v = C = 1, C = this.getter(0).length, v = C, Je("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = C, this._chunkSize = v, this.lengthKnown = !0;
      ...
      var h = _.createFile(n, a, f, s, u);
      f.contents ? h.contents = f.contents : f.url && (h.contents = null, h.url = f.url), Object.defineProperties(h, { usedBytes: { get: function() {
        return this.contents.length;
      } } });
      var y = {}, k = Object.keys(h.stream_ops);
      k.forEach((M) => {
        var I = h.stream_ops[M];
        y[M] = function() {
          return _.forceLoadFile(h), I.apply(null, arguments);
        };
      });
      function D(M, I, C, $, q) {
      ...
      return y.read = (M, I, C, $, q) => (_.forceLoadFile(h), D(M, I, C, $, q)), y.mmap = (M, I, C, $, q) => {
        _.forceLoadFile(h);
        var j = Mn(I);
        if (!j)
          throw new _.ErrnoError(48);
        return D(M, V, j, I, C), { ptr: j, allocated: !0 };
      }, h.stream_ops = y, h;
    } }, tt = (n, a) => (n >>>= 0, n ? je(te, n, a) : ""), R = { DEFAULT_POLLMASK: 5, calculateAt: function(n, a, i) {
      if (Y.isAbs(a))
        return a;
      var s;
      if (n === -100)
      ...
      b[i >>> 2] = s.dev, b[i + 4 >>> 2] = s.mode, B[i + 8 >>> 2] = s.nlink, b[i + 12 >>> 2] = s.uid, b[i + 16 >>> 2] = s.gid, b[i + 20 >>> 2] = s.rdev, ue[i + 24 >> 3] = BigInt(s.size), b[i + 32 >>> 2] = 4096, b[i + 36 >>> 2] = s.blocks;
      var u = s.atime.getTime(), c = s.mtime.getTime(), m = s.ctime.getTime();
      return ue[i + 40 >> 3] = BigInt(Math.floor(u / 1e3)), B[i + 48 >>> 2] = u % 1e3 * 1e3, ue[i + 56 >> 3] = BigInt(Math.floor(c / 1e3)), B[i + 64 >>> 2] = c % 1e3 * 1e3, ue[i + 72 >> 3] = BigInt(Math.floor(m / 1e3)), B[i + 80 >>> 2] = m % 1e3 * 1e3, ue[i + 88 >> 3] = BigInt(s.ino), 0;
    ...
    function ra(n, a) {
      try {
        return n = R.getStr(n), _.chmod(n, a), 0;
      } catch (i) {
    ...
    function aa(n, a, i, s) {
      try {
        if (a = R.getStr(a), a = R.calculateAt(n, a), i & -8)
          return -28;
    ...
    function la(n, a) {
      try {
        var i = R.getStreamFromFD(n);
        return R.doStat(_.stat, i.path, a);
      } catch (s) {
      ...
      try {
        ...
        for (var u = 280, c = 0, m = _.llseek(s, 0, 1), f = Math.floor(m / u); f < s.getdents.length && c + u <= i; ) {
          ...
          if (k === ".")
            ...
            h = M.id, y = _.isChrdev(M.mode) ? 2 : _.isDir(M.mode) ? 4 : _.isLink(M.mode) ? 10 : 8;
          }
          ue[a + c >> 3] = BigInt(h), ue[a + c + 8 >> 3] = BigInt((f + 1) * u), se[a + c + 16 >>> 1] = 280, V[a + c + 18 >>> 0] = y, Xe(k, a + c + 19, 256), c += u, f += 1;
        }
        ...
        switch (a) {
          ...
          case 21505: {
            ...
            if (s.tty.ops.ioctl_tcgets) {
              var u = s.tty.ops.ioctl_tcgets(s), c = R.get();
          ...
          case 21508: {
            ...
            if (s.tty.ops.ioctl_tcsets) {
              for (var c = R.get(), f = b[c >>> 2], h = b[c + 4 >>> 2], y = b[c + 8 >>> 2], k = b[c + 12 >>> 2], D = [], m = 0; m < 32; m++)
                D.push(V[c + m + 17 >>> 0]);
              return s.tty.ops.ioctl_tcsets(s.tty, a, { c_iflag: f, c_oflag: h, c_cflag: y, c_lflag: k, c_cc: D });
            }
            return 0;
          }
          case 21519: {
          ...
          case 21523: {
            ...
            if (s.tty.ops.ioctl_tiocgwinsz) {
              var M = s.tty.ops.ioctl_tiocgwinsz(s.tty), c = R.get();
    ...
    function fa(n, a) {
      try {
        return n = R.getStr(n), R.doStat(_.lstat, n, a);
      } catch (i) {
        if (typeof _ > "u" || i.name !== "ErrnoError") throw i;
        return -i.errno;
      }
    ...
    function pa(n, a, i, s) {
      try {
        ...
        return s = s & -6401, a = R.calculateAt(n, a, c), R.doStat(u ? _.lstat : _.stat, a, i);
      } catch (m) {
    ...
    function da(n, a, i, s) {
      R.varargs = s;
      try {
        a = R.getStr(a), a = R.calculateAt(n, a);
        var u = s ? R.get() : 0;
    ...
    function ha(n, a, i, s) {
      try {
        if (a = R.getStr(a), a = R.calculateAt(n, a), s <= 0) return -28;
    ...
    function ya(n, a, i, s) {
      try {
        return a = R.getStr(a), s = R.getStr(s), a = R.calculateAt(n, a), s = R.calculateAt(i, s), _.rename(a, s), 0;
      } catch (u) {
        if (typeof _ > "u" || u.name !== "ErrnoError") throw u;
        return -u.errno;
      }
    ...
    function wa(n) {
      try {
        return n = R.getStr(n), _.rmdir(n), 0;
      } catch (a) {
    ...
    function Sa(n, a) {
      try {
        return n = R.getStr(n), R.doStat(_.stat, n, a);
      } catch (i) {
        if (typeof _ > "u" || i.name !== "ErrnoError") throw i;
        return -i.errno;
      }
    ...
    function ka(n, a) {
      try {
        return n = R.getStr(n), a = R.getStr(a), _.symlink(n, a), 0;
      } catch (i) {
        if (typeof _ > "u" || i.name !== "ErrnoError") throw i;
        return -i.errno;
      }
    ...
    function va(n, a, i) {
      try {
        return a = R.getStr(a), a = R.calculateAt(n, a), i === 0 ? _.unlink(a) : i === 512 ? _.rmdir(a) : de("Invalid flags passed to unlinkat"), 0;
      } catch (s) {
        if (typeof _ > "u" || s.name !== "ErrnoError") throw s;
        return -s.errno;
      }
...
` + u.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    function jt(n, a, i) {
      ...
      function s(f) {
        var h = i(f);
        h.length !== n.length && Gt("Mismatched type converter count");
        for (var y = 0; y < n.length; ++y)
          me(n[y], h[y]);
      }
      var u = new Array(a.length), c = [], m = 0;
      a.forEach((f, h) => {
        ze.hasOwnProperty(f) ? u[h] = ze[f] : (c.push(f), Ve.hasOwnProperty(f) || (Ve[f] = []), Ve[f].push(() => {
          u[h] = ze[f], ++m, m === c.length && s(u);
        }));
      }), c.length === 0 && s(u);
    }
    var Da = function(n) {
      ...
      jt([n], c, (m) => {
        ...
        return u.forEach((h, y) => {
          var k = h.fieldName, D = m[y], M = h.getter, I = h.getterContext, C = m[y + u.length], $ = h.setter, q = h.setterContext;
          f[k] = { read: (j) => D.fromWireType(M(I, j)), write: (j, v) => {
            var P = [];
            $(q, j, C.toWireType(P, v)), Dn(P);
          } };
        }), [{ name: a.name, fromWireType: function(h) {
          var y = {};
          for (var k in f)
            y[k] = f[k].read(h);
          return s(h), y;
    ...
    function ba(n, a, i, s, u) {
      ...
      m && (u = (1n << 64n) - 1n), me(n, { name: a, fromWireType: function(f) {
        ...
        if (typeof h != "bigint" && typeof h != "number")
          throw new TypeError(`Cannot convert "${rt(h)}" to ${this.name}`);
        if (h < s || h > u)
          throw new TypeError(`Passing a number "${rt(h)}" from JS side to C/C++ side to an argument of type "${a}", which is outside the valid range [${s}, ${u}]!`);
        return h;
    ...
    function Aa(n) {
      if (!(this instanceof Re) || !(n instanceof Re))
        return !1;
    ...
    function Ba() {
      e.getInheritedInstanceCount = Ca, e.getLiveInheritedInstances = Ta, e.flushPendingDeletes = qt, e.setDelayFunction = Wa;
    }
    var ot = {};
    function La(n, a) {
    ...
    function za(n) {
      ...
      var c = this.registeredClass.getActualType(a), m = Cn[c];
      if (!m)
        return u.call(this);
      var f;
      this.isConst ? f = m.constPointerType : f = m.pointerType;
      var h = En(a, this.registeredClass, f.registeredClass);
      return h === null ? u.call(this) : this.isSmartPointer ? bt(f.registeredClass.instancePrototype, { ptrType: f, ptr: h, smartPtrType: this, smartPtr: n }) : bt(f.registeredClass.instancePrototype, { ptrType: f, ptr: h });
    }
    var _t = function(n) {
    ...
    function Na() {
      ...
      var n = _t(Object.create(Object.getPrototypeOf(this), { $$: { value: Ra(this.$$) } }));
      return n.$$.count.value += 1, n.$$.deleteScheduled = !1, n;
    }
    function Ha() {
      this.$$.ptr || Xt(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && N("Object already scheduled for deletion"), An(this), Rn(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0);
    }
    function Ua() {
      return !this.$$.ptr;
    }
    ...
    function $a() {
      Re.prototype.isAliasOf = Aa, Re.prototype.clone = Na, Re.prototype.delete = Ha, Re.prototype.isDeleted = Ua, Re.prototype.deleteLater = Fa;
    }
    function Re() {
    }
    function Ya(n, a, i) {
    ...
    function ye(n, a, i, s, u, c, m, f, h, y, k) {
      this.name = n, this.registeredClass = a, this.isReference = i, this.isConst = s, this.isSmartPointer = u, this.pointeeType = c, this.sharingPolicy = m, this.rawGetPointee = f, this.rawConstructor = h, this.rawShare = y, this.rawDestructor = k, !u && a.baseClass === void 0 ? s ? (this.toWireType = Xa, this.destructorFunction = null) : (this.toWireType = qa, this.destructorFunction = null) : this.toWireType = Va;
    }
    function Tn(n, a, i) {
    ...
    function Oa(n, a, i, s, u, c, m, f, h, y, k, D, M) {
      k = ee(k), c = we(u, c), f && (f = we(m, f)), y && (y = we(h, y)), M = we(D, M);
      var I = It(k);
      Qt(I, function() {
        Ln(`Cannot construct ${k} due to unbound types`, [s]);
      }), jt([n, a, i], s ? [s] : [], function(C) {
        C = C[0];
        var $, q;
        s ? ($ = C.registeredClass, q = $.instancePrototype) : q = Re.prototype;
        var j = Dt(I, function() {
        ...
        return Cn[n] = { pointerType: X, constPointerType: oe }, Tn(I, j), [O, X, oe];
      });
    }
    function ei() {
    ...
    var ce = new ei();
    function xn(n) {
      n >= ce.reserved && --ce.get(n).refcount === 0 && ce.free(n);
    }
    function ti() {
      for (var n = 0, a = ce.reserved; a < ce.allocated.length; ++a)
        ce.allocated[a] !== void 0 && ++n;
      return n;
    }
    function ni() {
      ce.allocated.push({ value: void 0 }, { value: null }, { value: !0 }, { value: !1 }), ce.reserved = ce.allocated.length, e.count_emval_handles = ti;
    }
    var fe = { toValue: (n) => (n || N("Cannot use deleted val. handle = " + n), ce.get(n).value), toHandle: (n) => {
      switch (n) {
        case void 0:
          return 1;
        case null:
        ...
        case !1:
          return 4;
        default:
          return ce.allocate({ refcount: 1, value: n });
      }
    } };
    function ri(n, a) {
    ...
    function _i(n, a, i, s, u, c) {
      ...
      for (var f = a[1] !== null && i !== null, h = !1, y = 1; y < a.length; ++y)
      ...
      h && (I += `var destructors = [];
`);
      var C = h ? "destructors" : "null", $ = ["throwBindingError", "invoker", "fn", "runDestructors", "retType", "classParam"], q = [N, s, u, Dn, a[0], a[1]];
      f && (I += "var thisWired = classParam.toWireType(" + C + `, this);
`);
      for (var y = 0; y < m - 2; ++y)
        I += "var arg" + y + "Wired = argType" + y + ".toWireType(" + C + ", arg" + y + "); // " + a[y + 2].name + `
...
`, $.push(I), zn(Function, $).apply(null, q);
    ...
    function ci(n, a, i, s, u, c, m) {
      ...
      n = ee(n), u = we(s, u), Qt(n, function() {
        ...
        return Tn(n, _i(n, y, null, u, c, m), a - 1), [];
      });
    }
    function gi(n, a, i, s, u) {
      ...
      var h = a.includes("unsigned"), y = (D, M) => {
      }, k;
      h ? k = function(D, M) {
    ...
    function mi(n, a, i) {
      ...
      function c(m) {
        m = m >> 2;
        var f = B, h = f[m >>> 0], y = f[m + 1 >>> 0];
        return new u(f.buffer, y, h);
      }
    ...
    function fi(n, a) {
      ...
      me(n, { name: a, fromWireType: function(s) {
        ...
        if (i)
          ...
          for (var M = new Array(u), h = 0; h < u; ++h)
            M[h] = String.fromCharCode(te[c + h >>> 0]);
          m = M.join("");
        }
        return Se(s), m;
        ...
        var f = Rt(4 + c + 1), h = f + 4;
        if (h >>>= 0, B[f >>> 2] = c, i && m)
          Xe(u, h, c + 1);
        else if (m)
          for (var y = 0; y < c; ++y) {
            var k = u.charCodeAt(y);
            k > 255 && (Se(h), N("String has UTF-16 code units that do not fit in 8 bits")), te[h + y >>> 0] = k;
          }
        else
          for (var y = 0; y < c; ++y)
            te[h + y >>> 0] = u[y];
    ...
    var Nn = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, pi = (n, a) => {
      ...
      i = ee(i);
      var s, u, c, m, f;
      a === 2 ? (s = pi, u = di, m = hi, c = () => Ze, f = 1) : a === 4 && (s = yi, u = wi, m = Si, c = () => B, f = 2), me(n, { name: i, fromWireType: function(h) {
        for (var y = B[h >>> 2], k = c(), D, M = h + 4, I = 0; I <= y; ++I) {
          var C = h + 4 + I * a;
          if (I == y || k[C >>> f] == 0) {
            var $ = C - M, q = s(M, $);
            D === void 0 ? D = q : (D += "\0", D += q), M = C + a;
          }
        }
        return Se(h), D;
      }, toWireType: function(h, y) {
        typeof y != "string" && N(`Cannot pass non-string to C++ string type ${i}`);
        var k = m(y), D = Rt(4 + k + a);
        return D >>>= 0, B[D >>> 2] = k >> f, u(y, D + 4, k + a), h !== null && h.push(Se, D), D;
      }, argPackAdvance: 8, readValueFromPointer: nt, destructorFunction: function(h) {
        Se(h);
      } });
    };
    ...
    function Mi(n, a, i, s, u, c, m, f, h, y) {
      vt[n].fields.push({ fieldName: ee(a), getterReturnType: i, getter: we(s, u), getterContext: c, setterArgumentType: m, setter: we(f, h), setterContext: y });
    }
    function Ii(n, a) {
    ...
    function Ei(n, a) {
      for (var i = new Array(n), s = 0; s < n; ++s)
        i[s] = Kt(B[a + s * 4 >>> 2], "parameter " + s);
      return i;
    }
    var Un = [];
    function Ci(n, a) {
      var i = Ei(n, a), s = i[0], u = s.name + "_$" + i.slice(1).map(function(C) {
        return C.name;
      }).join("_") + "$", c = Un[u];
      if (c !== void 0)
        return c;
      for (var m = ["retType"], f = [s], h = "", y = 0; y < n - 1; ++y)
        h += (y !== 0 ? ", " : "") + "arg" + y, m.push("argType" + y), f.push(i[1 + y]);
...
`, m.push(D);
      ...
      return c = Ri(I), Un[u] = c, c;
    }
    function Ti(n) {
      n > 4 && (ce.get(n).refcount += 1);
    }
    function Wi() {
      return fe.toHandle([]);
    }
    ...
    function Fn(n) {
      return B[n >>> 2] + b[n + 4 >>> 2] * 4294967296;
    }
    var Ni = (n, a) => {
    ...
    function Yi(n, a, i, s, u, c, m) {
      try {
        ...
        var f = R.getStreamFromFD(s), h = _.mmap(f, n, u, a, i), y = h.ptr;
        return b[c >>> 2] = h.allocated, y >>>= 0, B[m >>> 2] = y, 0;
      } catch (k) {
    ...
    function ji(n, a, i, s, u, c) {
      try {
        ...
        var m = R.getStreamFromFD(u);
        i & 2 && R.doMsync(n, m, a, s, c), _.munmap(m);
      } catch (f) {
        if (typeof _ > "u" || f.name !== "ErrnoError") throw f;
        return -f.errno;
      }
    ...
    var Yn = (n) => {
      ...
      var s = (/* @__PURE__ */ new Date()).getFullYear(), u = new Date(s, 0, 1), c = new Date(s, 6, 1), m = u.getTimezoneOffset(), f = c.getTimezoneOffset(), h = Math.max(m, f);
      B[n >>> 2] = h * 60, b[a >>> 2] = +(m != f);
      function y(C) {
        var $ = C.toTimeString().match(/\(([A-Za-z ]+)\)$/);
        return $ ? $[1] : "GMT";
      }
      var k = y(u), D = y(c), M = Yn(k), I = Yn(D);
      f < m ? (B[i >>> 2] = M, B[i + 4 >>> 2] = I) : (B[i >>> 2] = I, B[i + 4 >>> 2] = M);
    }, Vi = () => {
      de("");
    };
    function qi() {
    ...
    var Ji = (n, a, i) => te.copyWithin(n >>> 0, a >>> 0, a + i >>> 0), Ki = (n) => {
      ...
      if (n > i)
        return !1;
      for (var s = (h, y) => h + (y - h % y) % y, u = 1; u <= 4; u *= 2) {
        var c = a * (1 + 0.2 / u);
      ...
      return ct().forEach(function(s, u) {
        var c = a + i;
        B[n + u * 4 >>> 2] = c, es(s, c), i += s.length + 1;
      }), 0;
    }, ns = (n, a) => {
      var i = ct();
      B[n >>> 2] = i.length;
      ...
      Rr() || (e.onExit && e.onExit(n), zt = !0), S(n, new Ur(n));
    }, rs = (n, a) => {
      Vn(n);
    }, as = rs;
    function is(n) {
      try {
        var a = R.getStreamFromFD(n);
        return _.close(a), 0;
      } catch (i) {
        if (typeof _ > "u" || i.name !== "ErrnoError") throw i;
        return i.errno;
    ...
    function ss(n, a) {
      try {
        var i = 0, s = 0, u = 0, c = R.getStreamFromFD(n), m = c.tty ? 2 : _.isDir(c.mode) ? 3 : _.isLink(c.mode) ? 7 : 4;
    ...
    var qn = (n, a, i, s) => {
      for (var u = 0, c = 0; c < i; c++) {
        var m = B[a >>> 2], f = B[a + 4 >>> 2];
        a += 8;
        var h = _.read(n, V, m, f, s);
        if (h < 0) return -1;
        if (u += h, h < f) break;
        typeof s < "u" && (s += h);
      }
    ...
    function us(n, a, i, s, u) {
      try {
        ...
        var c = R.getStreamFromFD(n), m = qn(c, a, i, s);
        return B[u >>> 2] = m, 0;
      } catch (f) {
        if (typeof _ > "u" || f.name !== "ErrnoError") throw f;
        return f.errno;
    ...
    function _s(n, a, i, s) {
      try {
        var u = R.getStreamFromFD(n), c = qn(u, a, i);
        return B[s >>> 2] = c, 0;
      } catch (m) {
        if (typeof _ > "u" || m.name !== "ErrnoError") throw m;
        return m.errno;
    ...
    var ms = (n, a) => (Ut(te.subarray(n >>> 0, n + a >>> 0)), 0), fs = (n, a) => {
      ...
      for (var h in f)
        m = m.replace(new RegExp(h, "g"), f[h]);
      ...
      function $(v) {
        var P = ps(new Date(v.tm_year + 1900, 0, 1), v.tm_yday), O = new Date(P.getFullYear(), 0, 4), X = new Date(P.getFullYear() + 1, 0, 4), oe = C(O), Z = C(X);
        return I(oe, P) <= 0 ? I(Z, P) <= 0 ? P.getFullYear() + 1 : P.getFullYear() : P.getFullYear() - 1;
      }
...
`, "%p": (v) => v.tm_hour >= 0 && v.tm_hour < 12 ? "AM" : "PM", "%S": (v) => M(v.tm_sec, 2), "%t": () => "	", "%u": (v) => v.tm_wday || 7, "%U": (v) => {
      ...
      m = m.replace(/%%/g, "\0\0");
      for (var h in q)
        m.includes(h) && (m = m.replace(new RegExp(h, "g"), q[h](c)));
      m = m.replace(/\0\0/g, "%");
      var j = kt(m, !1);
    ...
    var qe = void 0;
    function Ms(n) {
      return qe || (qe = /* @__PURE__ */ new WeakMap(), vs(0, Te.length)), qe.get(n) || 0;
    }
    var er = [];
    function Is() {
      if (er.length)
    ...
    var Gs = { ga: Yr, H: Vr, a: qr, G: jr, ya: ra, za: aa, ja: ua, va: oa, K: _a, S: la, qa: ca, fa: ga, Ba: ma, sa: fa, ta: pa, I: da, ea: ha, _a: ya, $a: wa, ua: Sa, Za: ka, Q: va, Na: Da, W: ba, Fa: Pa, N: Oa, Ea: ri, x: ii, f: si, V: oi, q: ci, w: gi, o: mi, U: fi, L: ki, Oa: vi, M: Mi, Ga: Ii, wa: Gi, Va: bi, La: Ai, m: xn, Ma: Ci, E: Ti, Y: Wi, u: Bi, F: Li, s: xi, p: zi, ma: Ni, na: Fi, oa: $i, ka: Yi, la: ji, Xa: Xi, c: Vi, z: qi, Ya: Qi, D: Xn, xa: Ji, Wa: Zi, Ca: ts, Da: ns, y: as, B: is, R: ss, ia: us, ha: os, T: _s, pa: ls, ra: cs, J: gs, da: ms, Qa: Ys, P: zs, d: Rs, e: As, g: Ps, j: Ws, ca: $s, b: Ns, ba: Vs, n: xs, aa: qs, Ka: eu, Ja: tu, v: Hs, Sa: Us, t: Ls, Ta: Bs, O: js, l: Es, h: Cs, $: Qs, _: Js, k: bs, i: Ts, r: Xs, Pa: Zs, X: Os, Ia: nu, Z: Ks, Ha: ru, Ra: Fs, Aa: Vn, C: Zn, Ua: hs, A: ys };
    ...
    var Rt = e._malloc = function() {
      return (Rt = e._malloc = e.asm.Sj).apply(null, arguments);
    }, Se = e._free = function() {
      return (Se = e._free = e.asm.Tj).apply(null, arguments);
    }, gt = function() {
      return (gt = e.asm.Uj).apply(null, arguments);
    };
    ...
    var rr = function() {
      return (rr = e.asm.qn).apply(null, arguments);
    };
    ...
    var ar = function() {
      return (ar = e.asm.go).apply(null, arguments);
    };
    e.__embind_initialize_bindings = function() {
      return (e.__embind_initialize_bindings = e.asm.ho).apply(null, arguments);
    };
    var ir = function() {
      return (ir = e.asm.io).apply(null, arguments);
    }, H = function() {
      return (H = e.asm.jo).apply(null, arguments);
    }, U = function() {
      return (U = e.asm.ko).apply(null, arguments);
    }, F = function() {
      return (F = e.asm.lo).apply(null, arguments);
    }, sr = function() {
      return (sr = e.asm.mo).apply(null, arguments);
    }, ur = function() {
      return (ur = e.asm.no).apply(null, arguments);
    };
    function bs(n, a, i, s) {
      var u = U();
      try {
    ...
    function xs(n, a, i, s, u, c, m, f, h) {
      var y = U();
      try {
        return z(n)(a, i, s, u, c, m, f, h);
      } catch (k) {
    ...
    function Vs(n, a, i, s, u, c, m, f) {
      ...
      try {
        ...
        if (F(h), y !== y + 0) throw y;
        H(1, 0);
      }
    }
    function qs(n, a, i, s, u, c, m, f, h, y) {
      var k = U();
      try {
        return z(n)(a, i, s, u, c, m, f, h, y);
      } catch (D) {
    ...
    function Js(n, a, i, s, u, c, m, f, h, y, k) {
      var D = U();
      try {
        z(n)(a, i, s, u, c, m, f, h, y, k);
      } catch (M) {
        if (F(D), M !== M + 0) throw M;
        H(1, 0);
      }
    }
    function Ks(n, a, i, s, u, c, m, f, h, y) {
      var k = U();
      try {
        z(n)(a, i, s, u, c, m, f, h, y);
      } catch (D) {
        if (F(k), D !== D + 0) throw D;
        H(1, 0);
      }
    ...
    function eu(n, a, i, s, u, c, m, f, h, y, k, D) {
      var M = U();
      try {
        return z(n)(a, i, s, u, c, m, f, h, y, k, D);
      } catch (I) {
    ...
    function ru(n, a, i, s, u, c, m, f, h, y, k, D) {
      var M = U();
      try {
        z(n)(a, i, s, u, c, m, f, h, y, k, D);
      } catch (I) {
        if (F(M), I !== I + 0) throw I;
        H(1, 0);
      }
    ...
    function or() {
      if (We > 0 || (Er(), We > 0))
        return;
      function n() {
        Et || (Et = !0, e.calledRun = !0, !zt && (Cr(), o(e), e.onRuntimeInitialized && e.onRuntimeInitialized(), Tr()));
      }
...
class l {
  ...
  constructor() {
    this.loader = (r, e) => new Promise((o, g) => {
      ...
      wu(p).then((d) => {
        try {
          this.writeConfigurationFiles(d, e), tn(d, "MAGICK_CONFIGURE_PATH", (S) => {
            tn(d, "/xml", (G) => {
              d._Environment_SetEnv(S, G), this.api = d, o();
            });
          });
        } catch (S) {
          g(S);
  ...
  static read(r, e, o, g) {
    return ne._create((p) => {
      ...
      if (typeof r != "string" && !fr(r))
        ...
        d = o;
        let S;
        e instanceof Ie ? S = e : typeof e == "string" ? (S = new Ie(), S.format = e) : d = e, p.read(r, S);
      }
      return d(p);
    });
  }
  static readCollection(r, e, o) {
    return Me.create()._use((p) => {
      let d = o, S;
      return e instanceof Ie ? S = e : typeof e == "string" ? (S = new Ie(), S.format = e) : d = e, p.read(r, S), d(p);
    });
  }
  ...
  writeConfigurationFiles(r, e) {
    ...
    for (const g of e.all()) {
      const p = r.FS.open(`/xml/${g.fileName}`, "w"), d = new TextEncoder().encode(g.data);
      r.FS.write(p, d, 0, d.length), r.FS.close(p);
    }
  }
}
const Wt = new l();
async function oo(t, r) {
...
class ae {
  ...
  static progressDelegate(r, e, o, g) {
    ...
    if (p === void 0 || p.onProgress === void 0)
      return 1;
    const d = Number(e), S = Number(o), G = ge(r), W = new ku(G, d, S);
...
class Ee {
  ...
  supportsWriting;
  static get all() {
    return Ee._allFormats === void 0 && (Ee._allFormats = Ee.loadFormats()), Ee._allFormats;
  }
  static loadFormats() {
    return E.usePointer((r) => Ge.use((e) => {
      const o = l._api._MagickFormatInfo_CreateList(e.ptr, r), g = e.value;
      try {
        const p = new Array(g), d = Object.values(be);
        for (let S = 0; S < g; S++) {
          const G = l._api._MagickFormatInfo_GetInfo(o, S, r), W = ge(l._api._MagickFormatInfo_Format_Get(G)), x = Ee.convertFormat(W, d), re = ge(l._api._MagickFormatInfo_Description_Get(G), ""), pe = l._api._MagickFormatInfo_SupportsMultipleFrames_Get(G) == 1, Pe = l._api._MagickFormatInfo_SupportsReading_Get(G) == 1, Ce = l._api._MagickFormatInfo_SupportsWriting_Get(G) == 1;
          p[S] = new Ee(x, re, pe, Pe, Ce);
        }
        return p;
      } finally {
...
class De {
  ...
  static setLogEvents(r) {
    ...
    T(o, (g) => l._api._Magick_SetLogEvents(g));
  }
  /** @internal */
...
class bu {
   ...
   */
  constructor(r, e, o, g, p, d) {
    this._upperLeftX = r, this._upperLeftY = e, this._lowerRightX = o, this._lowerRightY = g, this._cornerWidth = p, this._cornerHeight = d;
  }
  draw(r) {
...
class _o {
   ...
   */
  roundRectangle(r, e, o, g, p, d) {
    return this._drawables.push(new bu(r, e, o, g, p, d)), this;
  }
  /**
...
class io extends Fe {
  constructor(r) {
    ...
    r.fontPointsize !== void 0 && l._api._MontageSettings_SetFontPointsize(this._instance, r.fontPointsize), r.frameGeometry !== void 0 && T(r.frameGeometry.toString(), (g) => {
      l._api._MontageSettings_SetFrameGeometry(this._instance, g);
    }), r.geometry !== void 0 && T(r.geometry.toString(), (g) => {
    ...
    }), r.textureFileName !== void 0 && T(r.textureFileName, (g) => {
      l._api._MontageSettings_SetTextureFileName(this._instance, g);
    }), r.tileGeometry !== void 0 && T(r.tileGeometry.toString(), (g) => {
      l._api._MontageSettings_SetTileGeometry(this._instance, g);
    }), r.title !== void 0 && T(r.title, (g) => {
...
export {
  ...
  co as ComplexSettings,
  Ct as CompositeOperator,
  ...
  dr as DensityUnit,
  Fu as DistortMethod,
  go as DistortSettings,
  ln as DitherMethod,
  ro as DngInterpolation,
  ao as DngOutputColor,
  lo as DngReadDefines,
  uo as DrawableColor,
  ...
  Lu as DrawableText,
  Ru as DrawableTextAlignment,
  pt as DrawableTextAntialias,
  Eu as DrawableTextDecoration,
  Cu as DrawableTextInterlineSpacing,
  Tu as DrawableTextInterwordSpacing,
  ...
  Zu as PixelInterpolateMethod,
  ve as Point,
  He as PrimaryInfo,
  ku as ProgressEvent,
  nn as QuantizeSettings,
  Ue as Quantum,
  Ou as RenderingIntent,
  cn as Statistics,
  eo as TextAlignment,
  to as TextDecoration,
  po as Threshold,
  on as TypeMetric,
  no as VirtualPixelMethod,
  mr as WarningEvent,
  mu as _getEdges,
  fr as _isByteArray,
  oo as initializeImageMagick
};
